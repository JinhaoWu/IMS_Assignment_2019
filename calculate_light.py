...
def calculation():
    ...
    with open('PSNR_light.csv','w',newline='') as psnr_csv:
    ...
    with open('VMAF_light.csv','w',newline='') as vmaf_csv:
    ...
    with open('SSIM_light.csv','w',newline='') as ssim_csv:
    ...
    with open('PSNRHVS_light.csv','w',newline='') as psnrhvs_csv:
    ...
    with open('VIFP_light.csv','w',newline='') as VIFP_csv:
    ...
    with open('PSNRHVSM_light.csv','w',newline='') as PSNRHVSM_csv:
